      ...
      <div className="bg-[#ffcc66] px-4 py-2 sm:px-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <Button className="hidden md:inline-flex" variant="secondary" onClick={onToggleCollapsed}>{collapsed ? t("expand") : t("collapse")}</Button>
          </div>
      ...
      <div className="flex items-center justify-between gap-4 bg-white px-4 py-3 sm:px-6 sm:py-4">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          <div className="flex h-10 w-[200px] items-center gap-2 rounded-lg border border-[#d9d9d9] px-3 sm:h-11 sm:w-[320px]">
            ...
            <Input className="h-9 border-0 p-0 text-[#363636] sm:h-10" placeholder={t("searchPlaceholder")} onChange={(e) => onSearch?.(e.target.value)} />
          </div>
